...
A family of functions allow you to read local datasets from your local 2dii Dropbox-folder.

```{r}
ALD.BV()
```

A family of datasets become directly available when you attach the r2dii.dataraw package.
...
This version of the r2dii.dataraw package could be merged into the main r2dii.dataraw repository. It should cause (almost) no merge conflict. Old behavior should not change.
