...
This article provides guidelines to document r2dii datasets. This should make it easier to understand existing datasets and to add new ones.

This guidelines are not written in stone. Feel free to [propose changes](https://github.com/2DegreesInvesting/r2dii/issues/new). And they are aspirational, so not all r2dii datasets may follow this guidelines.

For details about the documenting framework see the [roxygen2](https://roxygen2.r-lib.org) package.
